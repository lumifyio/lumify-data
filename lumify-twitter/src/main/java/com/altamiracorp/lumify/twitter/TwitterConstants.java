...
public interface TwitterConstants {
     ...
     */
    String LUMIFY_FAVORITE_COUNT_PROPERTY = "favoriteCount";
    
    /**
     * The Lumify retweet count property.
     */
    String LUMIFY_RETWEET_COUNT_PROPERTY = "retweetCount";
    
    /**
     * The Lumify status count property.
     */
    String LUMIFY_STATUS_COUNT_PROPERTY = "statusCount";
    
    /**
     * The Lumify follower count property.
     */
    String LUMIFY_FOLLOWER_COUNT_PROPERTY = "followerCount";
    
    /**
     * The Lumify following count property.
     */
    String LUMIFY_FOLLOWING_COUNT_PROPERTY = "followingCount";
    
    /**
     * The Lumify creation date property.
     */
    String LUMIFY_CREATION_DATE_PROPERTY = "creationDate";
