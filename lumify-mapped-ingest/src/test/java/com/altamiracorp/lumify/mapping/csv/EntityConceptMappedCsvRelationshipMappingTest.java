...
import com.altamiracorp.lumify.mapping.csv.EntityConceptMappedCsvRelationshipMapping.ConceptMapping;
...
public class EntityConceptMappedCsvRelationshipMappingTest {
    ...
    public void testSourceOnlyMapping() {
        EntityConceptMappedCsvRelationshipMapping instance = createInstance(FOO_SOURCE_MAPPING, PERSON_SOURCE_MAPPING);
    ...
    public void testTargetOnlyMapping() {
        EntityConceptMappedCsvRelationshipMapping instance = createInstance(BAR_TARGET_MAPPING, LOCATION_TARGET_MAPPING);
    ...
    public void testSourceTargetMapping() {
        EntityConceptMappedCsvRelationshipMapping instance = createInstance(
                FOO_SOURCE_MAPPING,
                BAR_TARGET_MAPPING,
    ...
    private void doGetLabelTest(final String testName, final EntityConceptMappedCsvRelationshipMapping instance,
    ...
    private void doGetLabelTest(final String testName, final EntityConceptMappedCsvRelationshipMapping instance,
        ...
        String label = instance.getLabel(source, target);
        assertEquals(String.format("[%s]: ", testName), expLabel, label);
    }

    private EntityConceptMappedCsvRelationshipMapping createInstance(final ConceptMapping... mappings) {
        EntityConceptMappedCsvRelationshipMapping instance =
                new EntityConceptMappedCsvRelationshipMapping(TEST_SRC_ID, TEST_TGT_ID, Arrays.asList(mappings));
    ...
    private void doTestConstructor(final String testName, final List<ConceptMapping> lblMap, final Class<? extends Throwable> expError) {
        try {
            new EntityConceptMappedCsvRelationshipMapping(TEST_SRC_ID, TEST_TGT_ID, lblMap);
