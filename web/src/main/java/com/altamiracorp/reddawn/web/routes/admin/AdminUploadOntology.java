...
import com.altamiracorp.reddawn.cmdline.OwlImport;
...
public class AdminUploadOntology implements Handler, AppAware {
    ...
    private void writePackage(RedDawnSession session, File file) throws ZipException, IOException, SAXException, ParserConfigurationException {
