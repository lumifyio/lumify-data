...
}else{return"rectangle"}}return i};A.prototype.getNodePadding=function(J){var L=J._private.style["padding-left"].value;var I=J._private.style["padding-right"].value;var K=J._private.style["padding-top"].value;var i=J._private.style["padding-bottom"].value;if(isNaN(L)){L=0}if(isNaN(I)){I=0}if(isNaN(K)){K=0}if(isNaN(i)){i=0}return{left:L,right:I,top:K,bottom:i}};A.prototype.matchCanvasSize=function(I){var O=this.data;var J=I.clientWidth;var Q=I.clientHeight;var K,L=J,P=Q,M=1;if(window.devicePixelRatio){M=window.devicePixelRatio;
L*=M;P*=M}for(var N=0;N<e;N++){K=O.canvases[N];if(K.width!==L||K.height!==P){K.width=L;K.height=P;K.getContext("2d").scale(M,M)}}for(var N=0;N<a;N++){K=O.bufferCanvases[N];if(K.width!==L||K.height!==P){K.width=L;K.height=P;K.getContext("2d").scale(M,M)}}this.data.overlay.style.width=J+"px";this.data.overlay.style.height=Q+"px"};var f=function(i){if(i._private.group=="nodes"){return i.parents().size()}else{if(i._private.group=="edges"){return Math.max(i.source()[0].parents().size(),i.target()[0].parents().size())
}else{return 0}}};A.prototype.getCachedZSortedEles=function(){var N=this.lastZOrderCachedNodes;var M=this.lastZOrderCachedEdges;var K=this.getCachedNodes();var J=this.getCachedEdges();var I=[];if(!N||!M||N!==K||M!==J){for(var L=0;L<K.length;L++){I.push(K[L])}for(var L=0;L<J.length;L++){I.push(J[L])}I.sort(D);this.cachedZSortedEles=I}else{I=this.cachedZSortedEles}this.lastZOrderCachedNodes=K;this.lastZOrderCachedEdges=J;return I};var D=function(J,I){var i=J._private.style["z-index"].value-I._private.style["z-index"].value;
var L=0;var K=0;if(J.cy().hasCompoundNodes()){L=f(J);K=f(I)}if(L-K===0){if(J._private.group==="nodes"&&I._private.group==="edges"){return 1}else{if(J._private.group==="edges"&&I._private.group==="nodes"){return -1}else{if(i===0){return J._private.index-I._private.index}else{return i}}}}else{return L-K}return 0};A.prototype.redraw=function(M,K){var i=this;if(this.averageRedrawTime===undefined){this.averageRedrawTime=0}var J=1000/60;var O=1000;var N=this.averageRedrawTime;N=Math.max(J,N);N=Math.min(N,O);
if(this.lastDrawTime===undefined){this.lastDrawTime=0}var P=+new Date;var I=P-this.lastDrawTime;var L=I>=N;if(!M){if(!L){clearTimeout(this.redrawTimeout);this.redrawTimeout=setTimeout(function(){i.redraw()},N);return}this.lastDrawTime=P}setTimeout(function(){var ag=P;var ab=100;var U=i.data.cy;var am=i.data;var ai=i.getCachedNodes();var T=i.getCachedEdges();i.matchCanvasSize(am.container);var af=[];for(var aj=0;aj<ai.length;aj++){af.push(ai[aj])}for(var aj=0;aj<T.length;aj++){af.push(T[aj])}if(am.canvasNeedsRedraw[d]||am.canvasNeedsRedraw[H]||K){if(i.hideEdgesOnViewport&&(i.pinching||i.hoverData.dragging||i.data.wheel||i.swipePanning)){}else{i.findEdgeControlPoints(T)
