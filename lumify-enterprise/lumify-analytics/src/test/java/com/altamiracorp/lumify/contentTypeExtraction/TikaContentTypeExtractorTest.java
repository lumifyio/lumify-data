...
public class TikaContentTypeExtractorTest {
    ...
    public void textExtract() throws Exception {
        ...
        assertEquals("video", contentTypeExtractor.extract(TikaContentTypeExtractor.class.getResourceAsStream("/MPEG-2.m2v"), "m2v"));
        ...
        assertEquals("document", contentTypeExtractor.extract(TikaContentTypeExtractor.class.getResourceAsStream("/test.abc"), "abc"));
    }
}
