...
public abstract class Base extends RedDawnCommandLineBase {
    ...
    protected int run(CommandLine cmd) throws Exception {
        ...
        int returnCode = defineOntology(redDawnSession, graph, entity);
    ...
    protected abstract int defineOntology(RedDawnSession redDawnSession, TitanGraph graph, Concept entity);
