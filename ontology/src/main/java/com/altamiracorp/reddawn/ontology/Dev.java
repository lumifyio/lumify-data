...
public class Dev extends Base {
    ...
    protected int defineOntology(TitanGraph graph, TitanGraphVertex entity) {
        ...
        TitanGraphVertex person = getOrCreateConcept(graph, entity, PERSON_TYPE);
        ...
        TitanGraphVertex org = getOrCreateConcept(graph, entity, ORGANIZATION_TYPE);
        ...
        TitanGraphVertex company = getOrCreateConcept(graph, org, COMPANY_TYPE);
        ...
        TitanGraphVertex location = getOrCreateConcept(graph, entity, LOCATION_TYPE);
        ...
        TitanGraphVertex phoneNumber = getOrCreateConcept(graph, entity, PHONE_NUMBER_TYPE);
        ...
        TitanGraphVertex emailAddress = getOrCreateConcept(graph, entity, EMAIL_ADDRESS_TYPE);
